...
| **Credit & Portfolio** | otorgamiento, cronograma de cuotas, cartera, asignación de abonos | ✅ dominio + repos; otorgamiento por API | `domain/credit/{schedule,portfolio}`, `apps/api/credit` |
...
| **Reporting** | read models (CQRS), dashboards, mapa | ❌ por construir | — |
